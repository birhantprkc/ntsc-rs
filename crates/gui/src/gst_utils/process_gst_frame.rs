...
fn frame_to_yiq(
    ...
    Ok(match in_format {
        VideoFormat::Rgbx | VideoFormat::Rgba => YiqOwned::from_strided_buffer::<Rgbx, u8>(
            ctx::global(),
            in_data,
            in_stride,
            width,
        ...
        VideoFormat::Bgrx | VideoFormat::Bgra => YiqOwned::from_strided_buffer::<Bgrx, u8>(
            ctx::global(),
            in_data,
            in_stride,
            width,
        ...
        VideoFormat::Xrgb | VideoFormat::Argb => YiqOwned::from_strided_buffer::<Xrgb, u8>(
            ctx::global(),
            in_data,
            in_stride,
            width,
        ...
        VideoFormat::Xbgr | VideoFormat::Abgr => YiqOwned::from_strided_buffer::<Xbgr, u8>(
            ctx::global(),
            in_data,
            in_stride,
            width,
        ...
        VideoFormat::Argb64 => {
            ...
            YiqOwned::from_strided_buffer::<Xrgb, u16>(
                ctx::global(),
                data_16,
                in_stride,
                width,
...
pub fn process_gst_frame<S: PixelFormat, T: Normalize>(
    ...
    match in_frame.info().interlace_mode() {
        VideoInterlaceMode::Progressive => {
            ...
            settings.apply_effect_to_yiq(ctx::global(), &mut view, frame as usize, [1.0, 1.0]);
